...
### Step 6: Set Up Daily Automation (Cronjobs) - This is optional if you want updated stocks/prices everyday otherwise just running create_db, populate_stocks, populate_prices will have data up to date
